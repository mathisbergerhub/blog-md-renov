...
const REPLACEMENTS = [
  ["Guides rénovation en Haute-Savoie", "Guides rénovation en Haute-Savoie & Savoie"],
  ['<h1>Mieux choisir, <span class="mdr-script-word">budget</span> clair, éviter les erreurs</h1>', '<h1>Mieux choisir,<br><span class="mdr-script-word">budget</span> clair,<br>éviter les erreurs</h1>'],
  ['<h1>Choisir juste, <span class="mdr-script-word">budgéter</span> clair, éviter les erreurs</h1>', '<h1>Mieux choisir,<br><span class="mdr-script-word">budget</span> clair,<br>éviter les erreurs</h1>'],
  ['<h1>Choisir juste,<br><span class="mdr-script-word">budgéter</span> clair,<br>éviter les erreurs</h1>', '<h1>Mieux choisir,<br><span class="mdr-script-word">budget</span> clair,<br>éviter les erreurs</h1>']
];
...
async function writeFile(path, token, sha, content) {
  return githubRequest(path, "PUT", token, {
    message: "Ajuste la promesse de la home",
