...
const REPLACEMENTS = [
  ['<h1>Choisir juste, <span class="mdr-script-word">budgéter</span> clair, éviter les erreurs</h1>', '<h1>Mieux choisir, <span class="mdr-script-word">budget</span> clair, éviter les erreurs</h1>'],
